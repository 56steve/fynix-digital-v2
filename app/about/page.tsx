      ...
      <section className="pt-12 md:pt-20 pb-14 md:pb-20 bg-gradient-to-b from-white to-background-soft">
        <Reveal className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <p className="text-text-muted text-base md:text-lg font-light leading-relaxed mt-6 max-w-2xl">
            ...
            technology, search placement, and outbound channels operate under a{" "}
            <strong className="font-medium text-primary">unified, continuous pipeline cycle</strong>.
          </p>
        </Reveal>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <Reveal>
            ...
            <p className="text-sm text-text-muted font-light leading-relaxed mt-3">
              We work <strong className="font-semibold text-primary">almost exclusively</strong>{" "}
              with cybersecurity companies. Our messaging, sales-cycle understanding, and buyer
              research are calibrated to that market.
            </p>
          </Reveal>
          <Reveal delay={120}>
            ...
            <p className="text-sm text-text-muted font-light leading-relaxed mt-3">
              ...
              <strong className="font-semibold text-primary">
                No agency handoffs, no context loss, no finger-pointing
              </strong>{" "}
              when metrics move.
            </p>
          </Reveal>
          <Reveal delay={240}>
            ...
            <p className="text-sm text-text-muted font-light leading-relaxed mt-3">
              We anchor{" "}
              <strong className="font-semibold text-primary">every engagement to a pipeline outcome</strong>
              : qualified conversations, sourced opportunities, or booked revenue. Not the number of
              assets delivered.
            </p>
          </Reveal>
        </div>
